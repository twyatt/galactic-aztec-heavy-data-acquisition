...
```
wget -qO- https://github.com/twyatt/galactic-aztec-heavy-data-acquisition/releases/download/0.6.0/server.tar | tar xv
```
_Where `0.6.0` should be replaced with the latest version number appearing on the [latest release] page._
